...
export const createMcpServer = (store: Store, queue: JobQueue): McpServer => {
  ...
  server.registerTool(
    'rag_jobs',
    {
      description: 'Show indexing queue status (pending/processing/failed jobs)',
    },
